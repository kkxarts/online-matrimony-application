...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | Occupation Profiles :: w3layouts</title>
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>Occupation here</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	...
	<div class="w3ls-list">
		<div class="container">
		<h2>Occupation Matrimonial Profiles list</h2>
							...
							<div class="col-md-6 one-w3-profile">
								<div class="profile-details">
									...
									<div class="w3-prfr">
										...
										<h4>Contact Now:</h4>
										<a href="#" data-toggle="modal" data-target="#myModal">Login</a><span>or</span><a href="index.php">Register</a>
										
									</div>
									<div class="clearfix"></div>
									<p class="light">Smart, Intelligent, well mannered and humble boy... <a href="groom_profile.php">read more</a></p>
								</div>
							</div>
							<div class="col-md-6 one-w3-profile">
								<div class="profile-details">
						...
						<div class="match-profile">
							<div class="col-md-6 one-w3-profile">
								<div class="profile-details">
									...
									<div class="clearfix"></div>
									<p class="light">My daughter, is fair, charming and broad minded. S... <a href="bride_profile.php">read more</a></p>
								</div>
							</div>
							<div class="col-md-6 one-w3-profile">
								<div class="profile-details">
