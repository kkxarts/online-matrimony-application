...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | FAQ :: w3layouts</title>
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>FAQ</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
