...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | Safety Tips :: w3layouts</title>
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>Safety Tips</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	...
	<!-- Safety tips -->
		<section class="terms-of-use">
			...
			<div class="agile_tips">
				<div class="container">
					<h2>Safety Tips</h2>
					<h5>PLEASE READ THIS SAFETY TIPS CAREFULLY .</h5>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseOne">
									 <span></span> How to Protect Details of your Profile?
								 </h4>
							</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								 <h4 class="panel-title" data-toggle="collapse"  data-target="#collapseTwo">
									<span></span> How to block and ignore profiles?
								 </h4>
							</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								 <h4 class="panel-title" data-toggle="collapse"  data-target="#collapseFive">
									<span></span> There are many variations of passages
								 </h4>
							</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseSix">
									<span></span> Contrary to popular belief
								 </h4>
							</div>
