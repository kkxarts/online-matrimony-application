...
<!-- head -->
<head>
<title>Match a Matrimonial Category Bootstrap Responsive Web Template | Help :: w3layouts</title>
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.php">Home</a> > <span>Help</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
