...
{
	extract($_REQUEST);
	 $t="INSERT INTO `advertisement`( `title`, `description`) VALUES ('$title','$description')";
	 $n=iud($t);
	if($n==1)
	{
		echo"<script>alert('Added');
...
###########################################################################
if(isset($_REQUEST['save_service_pannel']))
	{
...
$tmp_name=$_FILES["myfile"]["tmp_name"];
	...
	move_uploaded_file($tmp_name,"images/$name");
		 ...
		 $query="INSERT INTO `servicepannel`( `service_id`, `title`, `image`, `description`) VALUES ('$service','$title','$name','$description')";
	$n=iud($query);
	 if($n==1)
	 {
