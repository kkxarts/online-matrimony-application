						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="myphp.php">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="cast_name" class="form-control1" id="mediuminput" placeholder="Enter Text Here">
									</div>
								</div>
								<div class="form-group mb-n">
									<label for="largeinput" class="col-sm-2 control-label label-input-lg"></label>
									<div class="col-sm-8">
										<input type="submit" name="add_cast" class="form-control1 btn btn-warning input-sm" id="largeinput" placeholder="Large Input">
									</div>
								</div>
							</form>
						</div>
