...
if(mysqli_num_rows($res)>=1)
{
	...
	?>
	  <div class="col-sm-8" style="background-color:lavender;font-weight:;font-size:25px;">Mambership done with pakage <?=$amount?></div>
...
}else
{
	?>
	<div class="row" >
    <div class="col-sm-4" style="background-color:lavender;font-weight:;font-size:25px;">Pay 300 to view 10 profile's</div>
    <div class="col-sm-4" style="background-color:lavenderblush;font-weight:bold;font-size:21px;"><a href="payment.php?amount=300"><button class="btn btn-warning">PAY NOW</button></a></div>
  </div>
  </br>
   <div class="row">
    <div class="col-sm-4" style="background-color:lavender;font-size:25px;">Pay 800 to view 50 profile's</div>
    <div class="col-sm-4" style="background-color:lavenderblush;font-weight:bold;font-size:20px;"><a href="payment.php?amount=800"><button class="btn btn-warning">PAY NOW</button></a></div>
  </div></br>
  <div class="row">
    <div class="col-sm-4" style="background-color:lavender;font-size:25px;">Pay 1500 to view 100 profile's</div>
    <div class="col-sm-4" style="background-color:lavenderblush;font-weight:bold;font-size:20px;"><a href="payment.php?amount=1500"><button class="btn  btn-warning">PAY NOW</button></a> </div>
  </div>
	<?php
}
				?>
